 ...
 * Purpose: The Assignment3 class serves as the main entry point in the production environment,
...
/**
 * The Assignment3 class contains the main method, which serves as the entry point in the production environment.
...
public class Assignment3 {
	...
	/**
     * The main method serves as the entry point for the Assignment3 class in the production environment.
		...
		do {
			...
			try {
				...
				if ((request < 0) || (request > 4)) {
					System.out.println("Error: Please type digits from 0 to 4.");
					System.out.println("Usage: Valid input are digits from 0 to 4.");
					input.nextLine();
				} else {
				...
				System.out.println("Error: Please only type digits.");
				System.out.println("Usage: Valid input are digits from 0 to 4.");
				input.nextLine();
			}
		...
		do {
			...
			try {
				...
				if ((recipeNumber < 1) || (recipeNumber > recipesSize)) {
					System.out.println("Error: Please type digits from 1 to " + recipesSize + ".");
					System.out.println("Usage: Valid input are digits from 1 to " + recipesSize + ".");
					input.nextLine();
				} else {
					invalidNumber = false;
				}
		...
		do {
			...
			do {
				...
				try {
					...
					System.out.println("Error: Please only type digits.");
					System.out.println("Usage: Valid input are digits.");
					input.nextLine();
				}
			...
			if (!ordered) {
				System.out.println("Error: The total quantity of bread cannot be negative.");
				System.out.println("Usage: Valid total quantity are not negative.");
				input.nextLine();
			}
